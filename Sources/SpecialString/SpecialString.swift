...
public struct SpecialString<SpecialType: SpecialStringSpecialType> {
    /// The internal value of this type-safe string: a string which has no type safety other than being a string.
    ///
    /// - Attention: Be careful to never misplace this string! Doing so might have unintended consequences in your
    ///              software.
    public var withoutTypeSafety: String
}
...
extension SpecialString: EssentiallyAString {
    ...
    public var rawValue: String {
        get { withoutTypeSafety }
        set { withoutTypeSafety = newValue }
    }
    ...
    public init(rawValue: String) {
        self.withoutTypeSafety = rawValue
    }
}
